...
const Page = () => {
  ...
  useEffect(() => {
    dispatch(getCategories("skincare"));
  }, []);
  return (
    <div>
      {categoriesLoad ? (
                ...
                <Card.Body>
                  ...
                  <div className=" d-flex justify-content-center ">
                    ...
                    <Card.Text className="border-bottom border-success text-dark-emphasis fs-6 fw-bold me-2">
                      ...
                      {Math.ceil(
                        skinCare.price -
                          (skinCare.price * skinCare.discountPercentage) / 100
                      )}
                    </Card.Text>
                  ...
                  >
                    <Link
                      ...
                      href={`/productdetails/${skinCare.id}`}
                    >
                      {" "}
                      SHOW DETAILS
                    </Link>{" "}
