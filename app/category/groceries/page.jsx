...
const Page = () => {
  ...
  useEffect(() => {
    dispatch(getCategories("groceries"));
  }, []);
            ...
            {categories.map((grocerie, index) => (
              ...
              >
                ...
                <Card.Img
                  ...
                  style={{ height: "20rem" }}
                  variant="top"
                  src={grocerie.images[0]}
                />
                <Card.Body>
                  <Card.Title className="fs-6 fw-bold">
                    Brand {grocerie.brand}
                  </Card.Title>
                  <hr />
                  ...
                  <div className=" d-flex justify-content-center ">
                    ...
                    <Card.Text className="border-bottom border-success text-dark-emphasis fs-6 fw-bold me-2">
                      ...
                      {Math.ceil(
                        grocerie.price -
                          (grocerie.price * grocerie.discountPercentage) / 100
                      )}
                    </Card.Text>
                  ...
                  >
                    <Link
                      ...
                      href={`/productdetails/${grocerie.id}`}
                    >
                      {" "}
                      SHOW DETAILS
                    </Link>{" "}
