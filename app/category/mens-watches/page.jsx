...
const Page = () => {
  ...
  useEffect(() => {
    dispatch(getCategories("mens-watches"));
  }, []);
  return (
    <div>
      {categoriesLoad ? (
        <div style={{ padding: "14.5em" }}>
            ...
            {categories.map((man, index) => (
              ...
              >
                ...
                <Card.Body>
                  ...
                  <hr />
                  <Card.Text className="text-secondary">{man.title}</Card.Text>
                  <div className=" d-flex justify-content-center ">
                    ...
                    <Card.Text className="border-bottom border-success text-dark-emphasis fs-6 fw-bold me-2">
                      EGP{" "}
                      {Math.ceil(
                        man.price - (man.price * man.discountPercentage) / 100
                      )}
                    </Card.Text>
