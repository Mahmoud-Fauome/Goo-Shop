...
const Page = () => {
  ...
  useEffect(() => {
    dispatch(getCategories("furniture"));
  }, []);
            ...
            {categories.map((furn, index) => (
              ...
              >
                ...
                <Card.Body>
                  ...
                  <hr />
                  <Card.Text className="text-secondary">{furn.title}</Card.Text>
                  <div className=" d-flex justify-content-center ">
                    ...
                    <Card.Text className="border-bottom border-success text-dark-emphasis fs-6 fw-bold me-2">
                      ...
                      {Math.ceil(
                        furn.price -
                          (furn.price * furn.discountPercentage) / 100
                      )}
                    </Card.Text>
