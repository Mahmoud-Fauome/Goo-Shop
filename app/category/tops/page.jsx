            ...
            {categories.map((top, index) => (
              ...
              >
                ...
                <Card.Body>
                  ...
                  <hr />
                  <Card.Text className="text-secondary">{top.title}</Card.Text>
                  <div className=" d-flex justify-content-center ">
                    ...
                    <Card.Text className="border-bottom border-success text-dark-emphasis fs-6 fw-bold me-2">
                      EGP{" "}
                      {Math.ceil(
                        top.price - (top.price * top.discountPercentage) / 100
                      )}
                    </Card.Text>
