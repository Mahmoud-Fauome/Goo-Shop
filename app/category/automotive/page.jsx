...
const Page = () => {
  ...
  useEffect(() => {
    dispatch(getCategories("automotive"));
  }, []);
  return (
    <div>
      {categoriesLoad ? (
            ...
            {categories.map((auto, index) => (
              ...
              >
                ...
                <Card.Body>
                  ...
                  <hr />
                  <Card.Text className="text-secondary">{auto.title}</Card.Text>
                  <div className=" d-flex justify-content-center ">
                    ...
                    <Card.Text className="border-bottom border-success text-dark-emphasis fs-6 fw-bold me-2">
                      ...
                      {Math.ceil(
                        auto.price -
                          (auto.price * auto.discountPercentage) / 100
                      )}
                    </Card.Text>
